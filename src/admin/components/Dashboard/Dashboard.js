...
import CardChart1 from './widgets/CardChart1';
  ...
  controlledContent = () => {
	if(this.props.role == 'super' || this.props.role == 'core'){
		...
		<div>
		  ...
		  <Row>
			<CardChart1 role={this.props.role} />
			<CardChart2 role={this.props.role} />
			<CardChart3 role={this.props.role} />
			<CardChart4 role={this.props.role} />
		  </Row>

		  <Row>
			<MainChart role={this.props.role} />
		  </Row>

		  <Row>
		    <SocialBox1 role={this.props.role} />
		    <SocialBox2 role={this.props.role} />
		    <SocialBox3 role={this.props.role} />
		    <SocialBox4 role={this.props.role} />
		  </Row>
		</div>
		);
	}
